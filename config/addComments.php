...
<main>
    ...
    <div class="movie-card">
        <img src="<?= htmlspecialchars($movie['poster']) ?>" alt="<?= htmlspecialchars($movie['movie_name']) ?> poster" class="poster">
        <div>
        ...
        <form class="comment_n_rating" action="addComments.php" method="post">
            ...
            <div>
                ...
                <div class="rating-options">
                    <?php for ($i = 1; $i <= 10; $i++): ?>
                        <input type="radio" id="rating<?= $i ?>" name="rating" value="<?= $i ?>" <?= (isset($_POST['rating']) && $_POST['rating'] == $i) ? 'checked' : '' ?>>
