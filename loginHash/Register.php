...
$errors = [];
$profileImage = "default.jpeg";  // Default image
...
if (empty($errors)){
    ...
    $query ="INSERT INTO user_table (user_fname, user_name, user_gmail, user_password, user_image) 
             VALUES (:user_fname, :user_name, :user_gmail, :user_password, :user_image)";
    $statement = $db->prepare($query);
    $statement->bindValue(':user_fname', $fullName);
    $statement->bindValue(':user_name', $userName);
    $statement->bindValue(':user_gmail', $email);
    $statement->bindValue(':user_password', $hashedPassword);  // Store hashed password
